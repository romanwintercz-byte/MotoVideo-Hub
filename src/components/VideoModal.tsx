...
import { RideProject, AVAILABLE_TAGS, Highlight, ProjectStatus, TelemetryData } from '../types';
import { X, Plus, Trash2, Clock, Map, Activity, FolderOpen } from 'lucide-react';
...
export function VideoModal({ isOpen, onClose, onSave, initialData }: ProjectModalProps) {
                ...
                <div className="flex flex-col md:flex-row gap-3 items-start">
                  ...
                  <div className="flex-1 w-full">
                    <input
                      ...
                      placeholder="Co se stalo? (např. super zatáčka)"
